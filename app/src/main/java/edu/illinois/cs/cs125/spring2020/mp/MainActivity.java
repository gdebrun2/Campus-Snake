    ...
    private void setUpUi(final JsonObject result) {
        ...
        for (JsonElement g : games) {
            ...
            if (summary.isOngoing(myEmail)) {
                ...
                chunk = getLayoutInflater().inflate(R.layout.chunk_ongoing_game, ongoingLayout, false);
                ...
                chunk = getLayoutInflater().inflate(R.layout.chunk_invitation, invitationsLayout, false);
            ...
            // The labels for game owner and role are common to both chunks, so we can reduce code duplication
            ...
            TextView infoLabel = chunk.findViewById(R.id.gameRole); // Shows both the user's role and the game mode
