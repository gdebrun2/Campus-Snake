 ...
 * <p>
 * The implementation given here works. You do not need to change the logic, but there are a few
 * style problems you need to correct.
 * <p>
...
public class LineCrossDetector {
    ...
    public static boolean linesCross(final double firstStartLat, final double firstStartLng,
        ...
        if (LatLngUtils.same(intersectionX, firstStartLng)
                || LatLngUtils.same(intersectionX, firstEndLng)
                || LatLngUtils.same(intersectionX, secondStartLng)
                || LatLngUtils.same(intersectionX, secondEndLng)) {
